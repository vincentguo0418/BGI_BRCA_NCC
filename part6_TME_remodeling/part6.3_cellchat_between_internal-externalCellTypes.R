...
raw_adata_others = ReadH5AD(sprintf('ST/%s/Results/5_cellbin_230105/8.41_borderline/raw_annotated_bdl_others.h5ad', st_id))
...
system(sprintf('python 8.23.4_cellbin_merge_cluster_bin100_merge2rds.py -a ST/%s/Results/5_cellbin_230105/8.41.2_cell_communication/raw_annotated_bdl_others_external.h5ad -o %s/external_others -n 10', st_id, workdir))
system(sprintf('python 8.23.4_cellbin_merge_cluster_bin100_merge2rds.py -a ST/%s/Results/5_cellbin_230105/8.41.2_cell_communication/raw_annotated_bdl_others_internal.h5ad -o %s/internal_others -n 10', st_id, workdir))
...
adata_int_others$'borderline_surrounding_500' = 'int'
merge_adata_others = merge(adata_ext_others, adata_int_others)
merge_adata_all = merge_adata_others
...
#*statistics & filter out cell types with few cells
